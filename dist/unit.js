	...
	describe('Editor', function () {
	  ...
	  describe('applyDelta', function () {
	    ...
	    it('append formatted block embed', function () {
	      ...
	      editor.applyDelta(new _delta2.default().retain(5).insert({ video: '#' }).retain(1, { align: 'right' }) // Valid delta where newline does not follow block embed
	      .insert('\n'));
	    ...
	    it('append block embed', function () {
	      var editor = this.initialize(_editor2.default, '<p>0123</p>');
	      editor.applyDelta(new _delta2.default().retain(5).insert({ video: '#' }).insert('\n'));
	...
	describe('Clipboard', function () {
	  describe('events', function () {
	    ...
	    it('paste from external', function (done) {
	      ...
	      this.quill.clipboard.onPaste(this.event);
	      setTimeout(function () {
	        expect(_this.quill.root).toEqualHTML('<h1 id="01-78">01<strong>|</strong><em>7</em>8</h1>');
